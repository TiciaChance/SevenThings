...
class ViewController: UIViewController, SFSpeechRecognizerDelegate {
    ...
    private var recognitionTask: SFSpeechRecognitionTask? //gives the results of the recognizer request
    ...
    func startRecording() {
        ...
        textView.text = "Say something kind about yourself, I'm listening!"
    }
